...
module.exports = {
  ...
  entry: [require.resolve('./polyfills'), require.resolve('babel-polyfill'), paths.appIndexJsBuy],
  output: {
    // The build folder.
    path: paths.appBuildBuy,
    // Generated JS file names (with nested folders).
    // There will be one main bundle, and one file per asynchronous chunk.
    // We don't currently advertise code splitting but Webpack supports it.
    filename: 'static/js/[name]-chunk.[chunkhash:8].js',
    chunkFilename: 'static/js/[name]-chunk.[chunkhash:8].chunk.js',
  ...
  plugins: [
    ...
    new ReactLoadablePlugin({ filename: paths.appBuildBuy + '/react-loadable.json', }),
