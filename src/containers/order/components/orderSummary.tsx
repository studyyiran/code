  ...
  public render() {
    return (
      <div
        className={
          "comp-order-summary" +
          (this.state.isOpen || this.state.normal ? " isOpened" : "")
        }
      >
        <p>Order Summary</p>
        <div className="info-container">
          <MachineInfo
            productName={this.props.order.orderDetail.orderItem.productName}
            {...this.props.order.machineInfo}
          />
          <UserInfo {...this.props.order.userInformation} />
          {!this.state.normal && this.state.isOpen && (
