...
import InspectionComplete from '@/images/order/inspectionComplete.png';
...
export default class PackageReceived extends React.Component<IOrderProps> {
    public render() {
        return (
