        ...
        <section>
          <ProgressBar data={this.props.order.progressType} />
          {
            ...
            <div className="reviews-wrapper">
              ...
              <a href={`http://www.reviews.io/store/landing_new_review?store=uptradeit-com&user=${this.props.order.orderDetail.userName}&order_id=${this.props.order.orderDetail.orderNo}&email=${this.props.order.orderDetail.userEmail}&products=&type=company`} target="_blank"><Button type="primary" size="small" style={{ width: 170 }}>Write Your Review</Button></a>
            </div>
          }
