...
import {serverPhoneInfoQuestion, serverQuestionArr} from './mock'
...
export function Conditions(props: IConditions) {
  const {
    ...
    userPhoneConditionAnswer = []} = props
  const initState = {
  ...
  return <ConditionForm state={state} dispatch={dispatch} questionArr={serverQuestionArr} />;
}
