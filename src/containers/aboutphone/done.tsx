...
import './done.less';
import { IDoneProps } from './interface/index.interface';

@inject('yourphone')
@observer
export default class YoureDone extends React.Component<IDoneProps> {
  public render() {
    return (
      <div className="page-youredone-container">
        <Layout hideBottom={true}>
          <div className="content-wrapper">
            ...
            <p className="ship-btn" onClick={this.handleShip}>ALL GOOD. Let’s Ship It!</p>
          </div>
        </Layout>
      </div>
    );
