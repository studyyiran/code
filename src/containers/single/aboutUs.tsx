...
const articles: IArticle[] = [
    {
        ...
        text: "Treat customers great and great customers will treat you well. We are customer focused and continuously measure against our customer’s success."
    },
    {
        className: "width320",
        img: require('@/images/single/about-icon-2.png'),
        title: "Think Sustainably",
        text: "Make environmentally sustainable decisions that last for generations through recycling, reusing, or trading."
    },
    {
        className: "",
        img: require('@/images/single/about-icon-3.png'),
        title: "Earn Trust Through Service",
        text: "Be honest and transparent through every interaction with customers, employees, and partners."
    },
    {
        className: "",
    ...
    },
    {
        ...
        text: "Never settle for what has been done. Be creative and innovative using first principle thinking while reducing complexity."
    },
    {
        className: "width320",
        img: require('@/images/single/about-icon-6.png'),
        title: "Do Good and Be Responsible",
        text: "Be kind and take care of your neighbor. Do what is right, do what is good, and find balance."
    },
    {
        className: "width320",
        img: require('@/images/single/about-icon-7.png'),
        title: "Collaborative Teamwork",
        text: "We believe in fostering an inclusive work environment where all ideas are heard by building a positive culture and family spirit."
    }
]

const ArticleComp = (props: { className: string, img: string, title: string, text: string }) => (
            ...
            <section className="page-about-us">
                ...
                <div className="our-values">
                    ...
                    <section className="two-content">
                        {articles.map((v, i) => <ArticleComp key={i} {...v} />)}
                    </section>
