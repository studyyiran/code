  ...
  public render() {
    return (
      <div className="page-howmuch-container">
        ...
        <p>At UpTradeIt.com, our <Link to="/sell/account">price calculator</Link> can tell you how much your Phone is worth automatically. We provide a price guarantee which tells you how much we would pay you if you decide to let us sell your phone for you. </p>
        ...
        <p>1.Clean It: Follow the manufacturer’s recommendations on how to clean the outside of the phone. Don’t use typical household cleaners or abrasive cloths. However, try to get it as clean as possible, so it looks almost like new. </p>
        <p>2.Wipe It: Since you’ll be selling the phone to a new user, you’ll want to remove all your private data and pictures first. You’ll need to remove the SIM card too, but this won’t wipe the data. While the process of wiping the data may vary by manufacturer, here are some general steps.</p>
        <ul>
          <li>Backup all of your contacts, photos and other data </li>
          <li>Encrypt your data </li>
          <li>Perform a factory reset</li>
        </ul>
        <p>3.Pack It: For the best resale value, pack your phone in its original box, along with the original accessories or whatever else you plan on selling. If you don’t have the original box, be sure to pack it carefully so it doesn’t break during shipment.</p>
