  ...
  public render() {
    return (
      <div className="page-howmuch-container">
        ...
        <p>At UpTradeIt.com, our <Link to="/sell/account">price calculator</Link> can tell you how much your Phone is worth automatically. We provide a <em>price guarantee</em> which tells you how much we would pay you if you decide to let us sell your phone for you. </p>
