...
export default [
  ...
  },
  {
    component: Loadable({
      ...
      webpack: () => [
        require.resolveWeak("../containers/order/checkOrderNo") as number
      ]
    }),
    path: "/check-order",
    exact: true
  ...
  },
  {
    component: Loadable({
      ...
      webpack: () => [
        require.resolveWeak("../containers/order/container") as number
      ]
    }),
    path: "/order"
  },
  {
    component: Loadable({
      ...
      webpack: () => [
        require.resolveWeak("../containers/home/reviews") as number
      ]
    }),
    exact: true,
    path: "/reviews",
  ...
  },
  {
    ...
    component: Loadable({
      ...
      webpack: () => [
        require.resolveWeak("../containers/blog/detail") as number
      ]
    }),
    exact: true,
    path: "/:slug",
